    ...
    function (QuestionPlayerBase) {
        ...
        function start(player) {
            ...
            me._image_viewer_controller.open(true, function () {
                ...
                // check validity of available ROIs
        ...
        prototype._checkRoisValidity = function () {
            this.parent._checkRoisValidity.call(this,
                this._image_viewer_controller.checkRois(this._config.available_shapes)
            );
        };
